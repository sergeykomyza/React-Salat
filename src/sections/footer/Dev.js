...
import logoScrum from '../../img/logo-scrum.png'

export const Dev = () => {
	return (
		<div className="dev"> <span className="dev__rights"> © Все права защищены - Салат.ру  2021</span>
			<div className="dev__socials socials"><a className="socials__link" href="/">
			...
			<div className="dev__scrum scrum"> <span className="scrum__text">Разработка и <br />продвижение сайта</span><a href="/">	<img className="scrum__logo" src={logoScrum} alt="logo-scrum" /></a></div>
		</div>
	)
}